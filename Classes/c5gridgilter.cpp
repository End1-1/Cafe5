...
C5GridGilter::C5GridGilter(C5User *user) :
    C5Dialog(user),
...
bool C5GridGilter::filter(C5User *user, C5FilterWidget *filterWidget, QString &condition, QMap<QString, bool>& showColumns,
                          QHash<QString, QString>& colTranslation)
{
    C5GridGilter *gf = new C5GridGilter(user);
