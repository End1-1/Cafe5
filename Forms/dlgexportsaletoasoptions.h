...
public:
    explicit DlgExportSaleToAsOptions(C5User *user);

    ~DlgExportSaleToAsOptions();

    static int getOption(QString &partner, QString &store, QString &service, QString &srvinacc, QString &srvoutacc, QString &iteminacc, QString &itemoutacc, QString &bankacc, QString &vat, bool &exportSimple, QString &simpleItem, C5User *user);
