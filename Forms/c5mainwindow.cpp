...
void C5MainWindow::on_listWidgetItemClicked(const QModelIndex &index)
{
    ...
    case cp_t1_databases:
        createTab<CR5Databases>();
        break;

    case cp_t1_settigns:
        createTab<CR5Settings>();
        break;
    ...
    case cp_t2_goods_reservations:
        createTab<CR5GoodsReservations>();
        break;
    ...
    case cp_t3_sale_dishes:
        createTab<CR5SalesByDishes>();
        break;

    case cp_t3_sale_from_store_total:
        createTab<CR5SaleFromStoreTotal>();
        break;
    ...
    case cp_t3_consuption_reason:
        createTab<CR5ConsuptionReason>();
        break;

    case cp_t3_preorders:
        createTab<CR5Preorders>();
        break;

    case cp_t3_storage_uncomplected:
        createTab<CR5MaterialInStoreUncomplect>();
        break;

    case cp_t3_move_uncomplected:
        createTab<CR5MaterialMoveUncomplect>();
        break;
    ...
    case cp_t6_goods_special_prices:
        createTab<C5GoodsSpecialPrices>();
        break;

    case cp_t6_storage:
        createTab<CR5GoodsStorages>();
        break;

    case cp_t6_goods_images:
        createTab<CR5GoodsImages>();
        break;

    case cp_t6_qty_reminder:
        createTab<CR5GoodsQtyReminder>();
        break;

    case cp_t6_complectations:
        createTab<CR5Complectations>();
        break;

    case cp_t7_partners:
        createTab<CR5GoodsPartners>();
        break;

    case cp_t7_credit_card:
        createTab<CR5CreditCards>();
        break;

    case cp_t7_discount_system:
        createTab<CR5DiscountSystem>();
        break;
    ...
    case cp_t7_translator:
        createTab<C5TranslatorForm>();
        break;

    case cp_t7_store_reason:
        createTab<CR5StoreReason>();
        break;

    case cp_t7_order_marks:
        createTab<CR5OrderMarks>();
        break;
    ...
    case cp_t8_currency:
        createTab<CR5Currencies>();
        break;

    case cp_t8_edit_currency:
        createTab<CR5CurrencyRateHistory>();
        break;

    case cp_t8_currency_cross_rate:
        createTab<CR5CurrencyCrossRate>();
        break;
    ...
    case cp_t10_action_list:
        createTab<CR5MfActions>();
        break;

    case cp_t10_daily:
        createTab<CR5MfDaily>();
        break;

    case cp_t10_product_list:
        createTab<CR5MFProduct>();
        break;

    case cp_t10_general_report:
        createTab<CR5MFGeneralReport>();
        break;

    case cp_t10_general_report_only_date:
        createTab<CR5GeneralReportOnlyDate>();
        break;

    case cp_t10_actions_stages:
        createTab<CR5MFActionStage>();
        break;

    case cp_t10_workshops:
        createTab<CR5MFWorkshops>();
        break;

    case cp_t10_active_tasks:
        createTab<CR5MFActiveTasks>();
        break;

    default:
        if(permission < 0) {
            auto *reports = createTab<CR5Reports>();
