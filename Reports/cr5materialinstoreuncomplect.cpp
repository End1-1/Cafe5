...
CR5MaterialInStoreUncomplect::CR5MaterialInStoreUncomplect(const QStringList &dbParams, QWidget *parent) :
    C5ReportWidget(dbParams, parent)
{
    fIcon = ":/goods.png";
    fLabel = tr("Materials in the store without complects");
    fSimpleQuery = true;
    fFilter = new CR5MaterialInStoreUncomplectFilter(dbParams);
