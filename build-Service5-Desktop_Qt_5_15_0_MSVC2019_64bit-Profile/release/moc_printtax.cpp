...
QT_MOC_LITERAL(3, 15, 4), // "code"
QT_MOC_LITERAL(4, 20, 7) // "message"

    },
    "PrintTax\0done\0\0code\0message"
};
...
void PrintTax::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PrintTax *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (PrintTax::*)(int , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PrintTax::done)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PrintTax::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_PrintTax.data,
    qt_meta_data_PrintTax,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void PrintTax::done(int _t1, const QString & _t2)
{
