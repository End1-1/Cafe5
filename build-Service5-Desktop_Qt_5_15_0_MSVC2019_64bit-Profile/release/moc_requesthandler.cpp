...
#include <memory>
#include "../../Service5/handlers/requesthandler.h"
...
QT_MOC_LITERAL(3, 25, 4) // "code"
    ...
    "RequestHandler\0sendData\0\0code"
};
...
void RequestHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RequestHandler::*)(int , const QString & , const QString & , const QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RequestHandler::sendData)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RequestHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_RequestHandler.data,
    qt_meta_data_RequestHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void RequestHandler::sendData(int _t1, const QString & _t2, const QString & _t3, const QVariant & _t4)
{
