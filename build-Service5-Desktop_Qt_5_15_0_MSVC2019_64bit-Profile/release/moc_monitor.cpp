...
QT_MOC_LITERAL(4, 26, 7), // "session"
QT_MOC_LITERAL(5, 34, 5), // "data1"
QT_MOC_LITERAL(6, 40, 5) // "data2"

    },
    "Monitor\0receiveData\0\0code\0session\0"
    "data1\0data2"
};
...
static const uint qt_meta_data_Monitor[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::Int, QMetaType::QString, QMetaType::QString, QMetaType::QVariant,    3,    4,    5,    6,
...
void Monitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receiveData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3])),(*reinterpret_cast< const QVariant(*)>(_a[4]))); break;
        default: ;
        }
    }
}
