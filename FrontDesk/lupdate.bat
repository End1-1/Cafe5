...
cd /d "C:\Development\projects\cafe5\FrontDesk"
...
"D:\soft\Qt\6.8.0\msvc2022_64\bin\lupdate.exe" ^
    "." "../Cafe5" "../Classes" "../Forms" "../Editors" "../Controls" "../NTable" "../Printing" "../Reports" "../dictionaries" ^
    -ts "FrontDesk.ts" -recursive -no-obsolete
